    ...
    return (
      <div className="min-h-screen bg-gray-900 p-4 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400">Loading your quizzes...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-gray-900 p-4">
        <div className="max-w-4xl mx-auto">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-2xl font-bold text-purple-400">✏️ Edit Quiz</h1>
            <button
          ...
          <div className="bg-gray-800 rounded-2xl shadow-xl p-6 border border-purple-500/20">
            <div className="mb-4">
                    ...
                    <div className="flex-1">
                      ...
                      {q.options.map((opt: string, optIndex: number) => (
                        <input
                          ...
                          className="w-full p-2 border border-gray-600 rounded-lg mb-1 bg-gray-700 text-white"
                        />
                      ))}
                    </div>
                    <button
  ...
  return (
    <div className="min-h-screen bg-gray-900 p-4">
      <div className="max-w-6xl mx-auto">
        ...
        {quizzes.length === 0 ? (
          <div className="bg-gray-800 rounded-2xl shadow-xl p-12 text-center border border-purple-500/20">
            <div className="text-6xl mb-4">📝</div>
            <h2 className="text-2xl font-bold text-gray-300 mb-2">No Quizzes Yet</h2>
            <p className="text-gray-400 mb-4">Create your first quiz and share it with others!</p>
            <a
              href="/create"
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="md:col-span-1 space-y-4">
              <h2 className="font-semibold text-gray-300 mb-3">Your Quizzes</h2>
              {quizzes.map((quiz) => (
            ...
            <div className="md:col-span-2">
              {showResults ? (
                  ...
                  {results.length === 0 ? (
                    ...
                    <div className="space-y-4">
                      {results.map((result, index) => (
                        <div
                          key={index}
                          className="border border-gray-700 rounded-xl p-4 hover:bg-gray-700/50 transition"
                        >
                ...
                <div className="bg-gray-800 rounded-2xl shadow-xl p-12 text-center border border-purple-500/20">
                  <div className="text-4xl mb-4">👆</div>
                  <p className="text-gray-400">Select a quiz to view results</p>
                </div>
              )}
            </div>
          </div>
      ...
      {showDeleteConfirm && (
        <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 p-4">
          <div className="bg-gray-800 rounded-2xl shadow-2xl p-6 max-w-md w-full border border-purple-500/20">
            <h3 className="text-xl font-bold text-white mb-4">Delete Quiz?</h3>
